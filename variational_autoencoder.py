...
BATCH_SIZE = 4
LR_RATE = 3e-4 
SAVE_PATH = "/home/htic/axl/vae/img" # create a folder in the current directory
...
# test and save the reconstructed images
...
# ANALYSIS
# 92 MB of GPU RAM (GTX 1650 Ti) 15W during traing
